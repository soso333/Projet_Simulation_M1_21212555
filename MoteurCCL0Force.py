...
class MoteurCC : 
    ...
    def __init__(self, R=1, L=0, kc=0.01, ke=0.01, J_rotor = 0.01, f=0.1,  J_charge = 0.2, f_ext = 0.1):
        ...
        self.J = J_rotor + J_charge # Inertie du rotor + de la charge
        self.f = f + f_ext          # Constante de frottement visqueux + force de frottement externe
